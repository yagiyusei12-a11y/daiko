...
} from "../lib/sample-showcase-content";
...
export default function SampleShowcasePage(): JSX.Element {
  return (
      ...
      <div className="card" style={{ maxWidth: "44rem", width: "100%" }}>
        ...
        <section className="settings-section-panel" style={{ marginBottom: "1rem" }}>
          ...
          <ul className="settings-hint" style={{ margin: "0.35rem 0 0", paddingLeft: "1.2rem", lineHeight: 1.65 }}>
            <li>
              <strong>スタッフ画面</strong>：お持ちの<strong>店舗ID・メール・パスワード</strong>で{" "}
              <Link to="/login">ログイン</Link>してください。デモ用アカウントはテナント管理者が発行します。
            </li>
            <li>
              <strong>新規で店舗を作る</strong>：<Link to="/register">新規テナント登録</Link>から空のテナントを作成し、従業員やシフトを登録して試せます。
            </li>
            <li>
