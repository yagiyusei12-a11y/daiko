...
const versionPatchBodySchema = z
  .object({
    ...
    leftHandSurchargeFlatYen: z.number().int().min(0).optional(),
  ...
  app.post<{
    ...
    const ver = await prisma.tariffPlanVersion.create({
      data: {
        ...
        leftHandSurchargeFlatYen: last?.leftHandSurchargeFlatYen ?? 0,
  ...
  app.patch<{
    ...
    const updated = await prisma.tariffPlanVersion.update({
      ...
      data: {
        ...
        ...(b.leftHandSurchargeFlatYen !== undefined ? { leftHandSurchargeFlatYen: b.leftHandSurchargeFlatYen } : {}),
